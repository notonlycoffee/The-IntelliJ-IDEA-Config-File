...
To enable JRebel for your server container, please run:

bin/setup.{cmd|sh}

Follow the on-screen instructions. For the simplest use case (enabling JRebel for Tomcat), please run:
